...
context.fillStyle = "#E2739F"; context.fill();


var div = document.getElementById("about-text");

div.innerHTML = div.innerHTML + '<p>Hi! I\'m Jingyi, a recent <a href="http://eecs.berkeley.edu">EECS</a> graduate from UC Berkeley. I really like making things, and enabling others to do the same.</p>'
+
	'<p>At Berkeley, I do research under <a href="http://cs.berkeley.edu/~bjoern/">Bjoern Hartmann</a> in the <a href="http://bid.berkeley.edu">Berkeley Institute of Design</a>. For the past three semesters, I\'ve taught <a href="inst.eecs.berkeley.edu/~cs184/fa16">CS 184: Computer Graphics</a>, and <a href="http://teaching.paulos.net/cs160_FL2015/">CS160:</a> <a href="http://teaching.paulos.net/cs160_SP2016/">UI Design</a>. Broadly, my research interests include design tools for digital fabrication, some intersection of computer graphics, vision, and computational photography, and fan cultures.</p>'
+
	'<p>I graduated a semester early to intern as a UI/UX designer at <a href="http://nvidia.com">NVIDIA</a>. After that, I hope to continue my research through a PhD program in HCI! I use they/them pronouns.</p>'
